 ...
 */
@Data
public class DictCategoryUpdateDTO implements Serializable {
    ...
    private Boolean areaCoefficientImpactConfirmed;

    @Pattern(regexp = "^(subsequent_only|manual_recalc)?$", message = "面积系数生效口径值不合法")
    private String areaCoefficientEffectScope;

    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    private LocalDateTime lastKnownUpdatedAt;
