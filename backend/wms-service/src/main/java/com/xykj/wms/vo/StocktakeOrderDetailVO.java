...
@Data
public class StocktakeOrderDetailVO implements Serializable {
    ...
    private List<StocktakeVersionSummaryVO> versions;
    private List<StocktakeOperationLogVO> operationLogs;
}
