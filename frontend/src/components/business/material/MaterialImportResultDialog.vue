...
const visible = computed({
  get: () => materialStore.importResultVisible,
  set: (val) => {
    if (!val) materialStore.closeImportResult()
  }
})

const result = computed(() => materialStore.importResult)

const handleClose = () => {
  materialStore.closeImportResult()
}

const handleDownloadErrors = () => {
  materialStore.downloadErrorFile()
}
</script>
...
<template>
  <el-dialog
    ...
    align-center
    @close="handleClose"
    class="material-import-result-dialog"
  >
    <template #header>
...
<style lang="scss">
/* ---- Dialog 容器（unscoped） ---- */
.material-import-result-dialog.el-dialog {
  width: 480px;
  background: #FFFFFF;
...
.material-import-result-dialog.el-dialog .el-dialog__header {
  padding: 24px 24px 13px !important;
  margin-right: 0;
  border-bottom: 1px solid #E1E2E9;
}

.material-import-result-dialog.el-dialog .el-dialog__body {
...
.material-import-result-dialog.el-dialog .el-dialog__footer {
  padding: 0;
